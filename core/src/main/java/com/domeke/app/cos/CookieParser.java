...
public class CookieParser {
	 ...
	 */
	public byte getByteCookie(String name) throws CookieNotFoundException,
			NumberFormatException {
		return Byte.parseByte(getStringCookie(name));
	}

	/**
	 * Gets the named cookie value as a byte, with a default. Returns the
	 * default value if the cookie is not found or cannot be converted to a
	 * byte.
	 * 
	 * @param name
	 *            the cookie name
	...
	/**
	 * Gets the named cookie value as a char, with a default. Returns the
	 * default value if the cookie is not found.
	 * 
	 * @param name
	 *            the cookie name
	 ...
	 */
	public double getDoubleCookie(String name) throws CookieNotFoundException,
			NumberFormatException {
	 ...
	 */
	public float getFloatCookie(String name) throws CookieNotFoundException,
			NumberFormatException {
	 ...
	 */
	public int getIntCookie(String name) throws CookieNotFoundException,
			NumberFormatException {
	 ...
	 */
	public long getLongCookie(String name) throws CookieNotFoundException,
			NumberFormatException {
		return Long.parseLong(getStringCookie(name));
	}

	/**
	 * Gets the named cookie value as a long, with a default. Returns the
	 * default value if the cookie is not found.
	 * 
	 * @param name
	 *            the cookie name
	 ...
	 */
	public short getShortCookie(String name) throws CookieNotFoundException,
			NumberFormatException {
