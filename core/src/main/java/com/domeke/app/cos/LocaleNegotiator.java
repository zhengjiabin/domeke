 ...
 * 
 * LocaleNegotiator negotiator = new LocaleNegotiator(bundleName, acceptLanguage,
 * 		acceptCharset);
 * 
...
public class LocaleNegotiator {
	...
	/*
	 * Gets a ResourceBundle object for the given bundle name and locale, or
	 * null if the bundle can't be found. The resource bundle must match the
	 * locale exactly. Fallback matches are not permitted.
	 */
