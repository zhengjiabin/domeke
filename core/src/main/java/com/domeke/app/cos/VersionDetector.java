...
/**
 * A class to determine the current Servlet API version number, and the current
 * JDK version number. It looks at the available classes and variables to make
 * the determination. The class can detect Servlet API versions up to 2.2, and
 * JDK versions up to 1.3.
 * <p>
...
public class VersionDetector {
	...
	public static String getServletVersion() {
		...
		// Count up versions until a NoClassDefFoundError or
